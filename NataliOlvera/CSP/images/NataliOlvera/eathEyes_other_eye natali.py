...
earth_file = os.path.join(directory, 'student,jpg')
...
student_img.paste(earth_small, (708, 943), mask=earth_small) 
# Display
...
student_img.paste(earth_small, (1167, 985), mask=earth_small) 
# Display
fig3, axes3 = plt.subplots(1, 2)
axes3[0].imshow(student_img, interpolation='none')
axes3[1].imshow(student_img, interpolation='none')
