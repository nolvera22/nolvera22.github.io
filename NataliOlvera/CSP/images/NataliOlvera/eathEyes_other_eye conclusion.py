...
student_file = os.path.join(directory, 'babygirl.jpg')
...
axes[1].set_xlim(0,250) #coordinates measured in plt, and tried in iPython
...
earth_small = earth_img.resize((20, 10)) #eye width and height measured in plt
...
student_img.paste(earth_small, (140, 90), mask=earth_small) 
# Display
...
student_img.paste(earth_small, (80, 100), mask=earth_small) 
# Display
fig3, axes3 = plt.subplots(1, 2)
axes3[0].imshow(student_img, interpolation='none')
axes3[1].imshow(student_img, interpolation='none')
